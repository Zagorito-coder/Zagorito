...
| RÉSOLU LE 11 AOÛT 2026 | Identité professionnelle | DNS Hostinger `www.boosterfish.com` | Le site officiel et la boîte `support@boosterfish.com` sont désormais opérationnels. | Le domaine et l'adresse professionnelle remplacent le contact temporaire dans l'application, les politiques et Play Console. | Identité professionnelle cohérente sur tous les supports. | Validation fonctionnelle communiquée par l'éditeur et vérification HTTPS du domaine. | Clos |
