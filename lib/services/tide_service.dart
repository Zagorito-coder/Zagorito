...
class TideService {
  ...
  static Future<TideData> fetchTides({
    ...
    try {
      ...
      if (hourly == null) return TideData.fallback();
      ...
      if (times.isEmpty || heights.isEmpty) return TideData.fallback();
      ...
      if (points.isEmpty) return TideData.fallback();
      ...
      debugPrint('[TideService] Erreur récupération marées: $e');
      debugPrint('$st');
      return TideData.fallback();
    }
  }
